const concept={"id":4,"slug":"lab","name":"PathLab","thaiName":"ห้องทดลองเส้นทาง","descriptor":"Career exploration dashboard","headline":"เปิดดูได้ว่าแต่ละเส้นทางมาจากหลักฐานอะไร","subhead":"สำรวจข้อมูลจากเรื่องที่คุณเล่า ภารกิจที่ลอง และข้อจำกัดจริง—พร้อมแก้ไขสมมติฐานได้ทุกจุด","cta":"เข้าห้องทดลอง","interaction":"Drag evidence tokens into a route lab, adjust transparent weights, and compare outcomes."};
