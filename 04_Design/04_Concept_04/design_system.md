...
Bright cobalt data lab, modular bento panels, crisp geometry, charts, and evidence tokens.

## Color tokens

| Token | Value | Use |
|---|---:|---|
| Background | `#F3F7FC` | Page canvas |
| Surface | `#FFFFFF` | Cards, dialogs, forms |
| Primary text | `#14233A` | Headings and body |
| Muted text | `#66758A` | Supporting copy; verify AA contrast at each size |
| Primary action | `#245CEB` | Main CTA and active states |
| Secondary | `#16B6B0` | Supporting visualization/choice |
| Accent | `#B8E239` | Small highlights only |
| Border | `#D6E0EC` | Dividers and control outlines |

Never use color alone to represent route status, RIASEC signal, confidence, or progress.

## Typography

- UI/body stack: `"IBM Plex Sans Thai", "Noto Sans Thai", system-ui, sans-serif`
- Display stack: `"IBM Plex Sans Thai", "Noto Sans Thai", system-ui, sans-serif`
...
- Direction: Bright cobalt data lab, modular bento panels, crisp geometry, charts, and evidence tokens.
