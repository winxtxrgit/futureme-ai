# Timefold Content Guide

## Voice

Forward-looking, concrete, ambitious, and explicit about uncertainty.

## Hero copy

- Eyebrow: `Future self timeline`
- Headline: **ลองเห็นหลายอนาคต ก่อนเลือกก้าวถัดไป**
- Supporting copy: สำรวจฉากอนาคตหลายแบบ เปรียบเทียบสิ่งที่ต้องแลก และย้อนกลับมาวางแผนจากวันนี้
