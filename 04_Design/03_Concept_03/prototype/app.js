const concept={"id":3,"slug":"timeline","name":"Timefold","thaiName":"ไทม์ไลน์ตัวฉันในอนาคต","descriptor":"Future self timeline","headline":"ลองเห็นหลายอนาคต ก่อนเลือกก้าวถัดไป","subhead":"สำรวจฉากอนาคตหลายแบบ เปรียบเทียบสิ่งที่ต้องแลก และย้อนกลับมาวางแผนจากวันนี้","cta":"เปิดไทม์ไลน์ของฉัน","interaction":"Scroll or scrub through parallel future chapters, compare trade-offs, then reverse-plan."};
