# Timefold Design System

## Design intent

Cinematic dark canvas, luminous timeline ribbons, miniature future scenes, and time-based chapters.
...
| Surface | `#0D2038` | Cards, dialogs, forms |
| Primary text | `#F4F8FF` | Headings and body |
| Muted text | `#A8BAD0` | Supporting copy; verify AA contrast at each size |
| Primary action | `#43D7E8` | Main CTA and active states |
| Secondary | `#8F6BFF` | Supporting visualization/choice |
| Accent | `#FFB85A` | Small highlights only |
| Border | `#26425F` | Dividers and control outlines |
...
- Display stack: `"Arial Narrow", "Noto Sans Thai", system-ui, sans-serif`
...
- Direction: Cinematic dark canvas, luminous timeline ribbons, miniature future scenes, and time-based chapters.
