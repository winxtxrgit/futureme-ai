const concept={"id":7,"slug":"story","name":"Tomorrow Stories","thaiName":"เรื่องเล่าของวันพรุ่งนี้","descriptor":"Story-based career adventure","headline":"ลองใช้ชีวิตหนึ่งวัน ก่อนเลือกบทถัดไป","subhead":"เล่นเรื่องสั้นจากโลกงาน ตัดสินใจในสถานการณ์จริง และค่อยย้อนดูว่าคุณเลือกแบบนั้นเพราะอะไร","cta":"เปิดเรื่องแรก","interaction":"Branching narrative choices followed by Socratic debrief and a replay-from-another-perspective option."};
