# Tomorrow Stories Design System

## Design intent

Graphic-novel panels, bold ink, risograph texture, chapter cards, and cinematic branching doors.

## Color tokens

| Token | Value | Use |
|---|---:|---|
| Background | `#F4E9D1` | Page canvas |
| Surface | `#FFF8E9` | Cards, dialogs, forms |
| Primary text | `#102A43` | Headings and body |
| Muted text | `#6E665B` | Supporting copy; verify AA contrast at each size |
| Primary action | `#D84A32` | Main CTA and active states |
| Secondary | `#1A8F91` | Supporting visualization/choice |
| Accent | `#D9A928` | Small highlights only |
| Border | `#C9B999` | Dividers and control outlines |
...
- Display stack: `"Arial Black", "Noto Sans Thai", system-ui, sans-serif`
...
- Direction: Graphic-novel panels, bold ink, risograph texture, chapter cards, and cinematic branching doors.
