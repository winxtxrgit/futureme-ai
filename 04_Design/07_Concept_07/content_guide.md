# Tomorrow Stories Content Guide

## Voice

Vivid, concise, curious, and reflective after each choice.

## Hero copy

- Eyebrow: `Story-based career adventure`
- Headline: **ลองใช้ชีวิตหนึ่งวัน ก่อนเลือกบทถัดไป**
- Supporting copy: เล่นเรื่องสั้นจากโลกงาน ตัดสินใจในสถานการณ์จริง และค่อยย้อนดูว่าคุณเลือกแบบนั้นเพราะอะไร
- Primary CTA: **เปิดเรื่องแรก**
