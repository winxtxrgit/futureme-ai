const concept={"id":5,"slug":"quest","name":"QuestMap","thaiName":"แผนที่ภารกิจค้นหาตัวตน","descriptor":"Gamified self-discovery journey","headline":"ค้นหาตัวเองด้วยการลอง ไม่ใช่การเดา","subhead":"เลือกโซน ทำภารกิจ 3 นาที เก็บหลักฐานจากสิ่งที่คุณลงมือทำ แล้วค่อยเปิดเส้นทางใหม่","cta":"เริ่มภารกิจแรก","interaction":"Choose a zone, complete a 3–5 minute scenario, collect evidence badges, and unlock route clues."};
