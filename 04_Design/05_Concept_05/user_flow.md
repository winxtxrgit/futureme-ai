...
→ A friendly guide asks short questions between missions; responses alter the next challenge.
→ editable evidence summary
→ choose a scenario mission
→ mission debrief
→ Route cards appear as unlocked regions with evidence badges and a Try next action.
→ compare three route strategies
→ A map trail of missions and milestones rather than a formal Gantt-like plan.
→ save
...
Choose a zone, complete a 3–5 minute scenario, collect evidence badges, and unlock route clues.
