# QuestMap Content Guide

## Voice

Energetic, friendly, low-pressure, and never competitive.

## Hero copy

- Eyebrow: `Gamified self-discovery journey`
- Headline: **ค้นหาตัวเองด้วยการลอง ไม่ใช่การเดา**
- Supporting copy: เลือกโซน ทำภารกิจ 3 นาที เก็บหลักฐานจากสิ่งที่คุณลงมือทำ แล้วค่อยเปิดเส้นทางใหม่
- Primary CTA: **เริ่มภารกิจแรก**
