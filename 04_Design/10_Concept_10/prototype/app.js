const concept={"id":10,"slug":"pulse","name":"Pulse","thaiName":"ฟีดทดลองอนาคต","descriptor":"Gen-Z social and visual experience","headline":"ลองสั้น ๆ รู้จักตัวเองเพิ่มทีละนิด","subhead":"ฟีดภารกิจส่วนตัวที่วัดพลังและความรู้สึกจากการลงมือทำ—ไม่มีไลก์ ไม่มีอันดับ ไม่มีคำทำนาย","cta":"ปัดดูภารกิจ","interaction":"Swipe experiment cards, hold to preview, submit a quick artifact, and react with effort/energy—not likes."};
