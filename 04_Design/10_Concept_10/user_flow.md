...
→ AI prompts appear as short visual story cards with voice or text replies.
→ editable evidence summary
→ choose a scenario mission
→ mission debrief
→ A visual route carousel backed by expandable evidence captions and no public rank.
→ compare three route strategies
→ A vertical story reel of upcoming experiments and milestones.
→ save
...
Swipe experiment cards, hold to preview, submit a quick artifact, and react with effort/energy—not likes.
