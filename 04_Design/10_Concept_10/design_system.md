...
Hot coral and ultraviolet gradients, editorial collage, story frames, sticker shapes, and bold type.

## Color tokens

| Token | Value | Use |
|---|---:|---|
| Background | `#15102A` | Page canvas |
| Surface | `#241A45` | Cards, dialogs, forms |
| Primary text | `#FFF8FF` | Headings and body |
| Muted text | `#C8BDDB` | Supporting copy; verify AA contrast at each size |
| Primary action | `#FF5364` | Main CTA and active states |
| Secondary | `#825CFF` | Supporting visualization/choice |
| Accent | `#C8FF4D` | Small highlights only |
| Border | `#46366D` | Dividers and control outlines |
...
- Direction: Hot coral and ultraviolet gradients, editorial collage, story frames, sticker shapes, and bold type.
