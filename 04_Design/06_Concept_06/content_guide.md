...
Calm, empathetic, boundaried, and never clinical or authoritative.

## Hero copy

- Eyebrow: `Digital guidance counselor`
- Headline: **พื้นที่เงียบ ๆ สำหรับคิดเรื่องใหญ่ของคุณ**
- Supporting copy: นาราช่วยฟัง สะท้อน และเตรียมคำถามที่ควรคุยต่อกับครู ผู้ปกครอง หรือคนที่คุณไว้ใจ
- Primary CTA: **คุยกับนารา**
