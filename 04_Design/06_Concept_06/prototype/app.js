const concept={"id":6,"slug":"counselor","name":"Nara","thaiName":"เพื่อนแนะแนวดิจิทัล","descriptor":"Digital guidance counselor","headline":"พื้นที่เงียบ ๆ สำหรับคิดเรื่องใหญ่ของคุณ","subhead":"นาราช่วยฟัง สะท้อน และเตรียมคำถามที่ควรคุยต่อกับครู ผู้ปกครอง หรือคนที่คุณไว้ใจ","cta":"คุยกับนารา","interaction":"Voice-or-text counseling session with reflective summaries and consent checkpoints."};
