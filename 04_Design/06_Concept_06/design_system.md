...
Soft sage interiors, natural materials, curved seating, and an original pebble-shaped AI presence.

## Color tokens

| Token | Value | Use |
|---|---:|---|
| Background | `#EEF3EA` | Page canvas |
| Surface | `#FAFCF7` | Cards, dialogs, forms |
| Primary text | `#26352E` | Headings and body |
| Muted text | `#69786F` | Supporting copy; verify AA contrast at each size |
| Primary action | `#3D6E58` | Main CTA and active states |
| Secondary | `#E79C72` | Supporting visualization/choice |
| Accent | `#D6BE79` | Small highlights only |
| Border | `#D3DDD2` | Dividers and control outlines |
...
- Direction: Soft sage interiors, natural materials, curved seating, and an original pebble-shaped AI presence.
