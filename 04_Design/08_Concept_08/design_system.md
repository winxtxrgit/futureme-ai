# Skill Constellation Design System

## Design intent

Deep indigo space, luminous glass nodes, elegant data-art, and connected clusters.

## Color tokens

| Token | Value | Use |
|---|---:|---|
| Background | `#090B22` | Page canvas |
| Surface | `#131633` | Cards, dialogs, forms |
| Primary text | `#F3F1FF` | Headings and body |
| Muted text | `#A5A8C7` | Supporting copy; verify AA contrast at each size |
| Primary action | `#6D5DFB` | Main CTA and active states |
| Secondary | `#16D8E5` | Supporting visualization/choice |
| Accent | `#F4B84D` | Small highlights only |
| Border | `#2D3155` | Dividers and control outlines |
...
- Display stack: `"Avenir Next", "Noto Sans Thai", system-ui, sans-serif`
...
- Direction: Deep indigo space, luminous glass nodes, elegant data-art, and connected clusters.
