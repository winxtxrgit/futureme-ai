const concept={"id":8,"slug":"constellation","name":"Skill Constellation","thaiName":"จักรวาลทักษะของฉัน","descriptor":"Skill and interest mapping platform","headline":"หนึ่งทักษะ พาคุณไปได้มากกว่าหนึ่งทาง","subhead":"เชื่อมสิ่งที่ชอบ สิ่งที่เคยทำ และทักษะที่พิสูจน์แล้ว เข้ากับเส้นทางเรียนและอาชีพแบบเห็นภาพ","cta":"เปิดแผนที่ทักษะ","interaction":"Pan, zoom, filter, and connect evidence nodes; expand bridges between career clusters."};
