# Skill Constellation Content Guide

## Voice

Exploratory, precise, non-mystical, and explicit that links are evidence relationships.

## Hero copy

- Eyebrow: `Skill and interest mapping platform`
- Headline: **หนึ่งทักษะ พาคุณไปได้มากกว่าหนึ่งทาง**
- Supporting copy: เชื่อมสิ่งที่ชอบ สิ่งที่เคยทำ และทักษะที่พิสูจน์แล้ว เข้ากับเส้นทางเรียนและอาชีพแบบเห็นภาพ
- Primary CTA: **เปิดแผนที่ทักษะ**
