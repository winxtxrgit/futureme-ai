# The Mirror Interview Content Guide

## Voice

Reflective, non-judgmental, precise, and spacious.

## Hero copy

- Eyebrow: `Interactive personality interview`
- Headline: **คำตอบไม่ได้อยู่ในตัวเลือก แต่อยู่ในเรื่องที่คุณเคยทำ**
- Supporting copy: บทสัมภาษณ์ส่วนตัวที่ช่วยสะท้อนความสนใจ คุณค่า และหลักฐานจากประสบการณ์จริงของคุณ
- Primary CTA: **เปิดห้องสะท้อนตัวตน**
