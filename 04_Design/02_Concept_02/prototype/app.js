const concept={"id":2,"slug":"mirror","name":"The Mirror Interview","thaiName":"บทสนทนากับตัวเอง","descriptor":"Interactive personality interview","headline":"คำตอบไม่ได้อยู่ในตัวเลือก แต่อยู่ในเรื่องที่คุณเคยทำ","subhead":"บทสัมภาษณ์ส่วนตัวที่ช่วยสะท้อนความสนใจ คุณค่า และหลักฐานจากประสบการณ์จริงของคุณ","cta":"เปิดห้องสะท้อนตัวตน","interaction":"Chaptered reflective prompts, pause-to-note moments, and editable evidence fragments."};
