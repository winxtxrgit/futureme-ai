# The Mirror Interview Design System

## Design intent

Frosted glass, editorial collage, soft violet gradients, mirror facets, and quiet gallery pacing.

## Color tokens

| Token | Value | Use |
|---|---:|---|
| Background | `#F5F0F6` | Page canvas |
| Surface | `#FFF9FC` | Cards, dialogs, forms |
| Primary text | `#30243D` | Headings and body |
| Muted text | `#74657C` | Supporting copy; verify AA contrast at each size |
| Primary action | `#7C4D8F` | Main CTA and active states |
| Secondary | `#E8A58C` | Supporting visualization/choice |
| Accent | `#C9A8E5` | Small highlights only |
| Border | `#DED1E2` | Dividers and control outlines |

Never use color alone to represent route status, RIASEC signal, confidence, or progress.

## Typography

- UI/body stack: `"Avenir Next", "Noto Sans Thai", system-ui, sans-serif`
- Display stack: `"Iowan Old Style", "Noto Serif Thai", Georgia, serif`
...
- Direction: Frosted glass, editorial collage, soft violet gradients, mirror facets, and quiet gallery pacing.
