# Compass Coach Content Guide

## Voice

Warm, brief, reflective, never directive.

## Hero copy

- Eyebrow: `AI career discovery coach`
- Headline: **ไม่ต้องรู้คำตอบทั้งหมด แค่เริ่มจากก้าวถัดไป**
- Supporting copy: คุยกับ AI Coach ลองภารกิจสั้น ๆ แล้วเห็น 3 เส้นทางเรียน–อาชีพที่อธิบายได้จากเรื่องจริงของคุณ
- Primary CTA: **เริ่มค้นหาเส้นทาง**
