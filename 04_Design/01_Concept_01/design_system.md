# Compass Coach Design System

## Design intent

Warm editorial paper-cut landscapes, compass metaphors, rounded cards, and generous calm space.

## Color tokens

| Token | Value | Use |
|---|---:|---|
| Background | `#F7F3EA` | Page canvas |
| Surface | `#FFFFFF` | Cards, dialogs, forms |
| Primary text | `#15253D` | Headings and body |
| Muted text | `#617083` | Supporting copy; verify AA contrast at each size |
| Primary action | `#F06F54` | Main CTA and active states |
| Secondary | `#78C7B4` | Supporting visualization/choice |
| Accent | `#F4C66A` | Small highlights only |
| Border | `#DCD6C9` | Dividers and control outlines |
...
- Direction: Warm editorial paper-cut landscapes, compass metaphors, rounded cards, and generous calm space.
