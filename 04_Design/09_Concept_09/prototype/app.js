const concept={"id":9,"slug":"clarity","name":"Clarity","thaiName":"การประเมินที่ชัดเจน","descriptor":"Minimal professional assessment","headline":"คำแนะนำที่อ่านเข้าใจ และตรวจสอบได้","subhead":"การประเมินที่เรียบง่าย แสดงหลักฐาน ความไม่แน่นอน และก้าวถัดไปโดยไม่ฟันธงอนาคต","cta":"เริ่มการประเมิน","interaction":"Linear assessment with save-and-return, keyboard-first controls, and explicit progress."};
