...
Swiss-inspired grid, warm white, restrained teal, sharp type hierarchy, and almost no decoration.

## Color tokens

| Token | Value | Use |
|---|---:|---|
| Background | `#F7F7F3` | Page canvas |
| Surface | `#FFFFFF` | Cards, dialogs, forms |
| Primary text | `#121716` | Headings and body |
| Muted text | `#5F6B67` | Supporting copy; verify AA contrast at each size |
| Primary action | `#176B62` | Main CTA and active states |
| Secondary | `#52738F` | Supporting visualization/choice |
| Accent | `#C9953D` | Small highlights only |
| Border | `#CBD2CD` | Dividers and control outlines |

Never use color alone to represent route status, RIASEC signal, confidence, or progress.

## Typography

- UI/body stack: `"Helvetica Neue", "Noto Sans Thai", Arial, sans-serif`
- Display stack: `"Helvetica Neue", "Noto Sans Thai", Arial, sans-serif`
...
- Direction: Swiss-inspired grid, warm white, restrained teal, sharp type hierarchy, and almost no decoration.
