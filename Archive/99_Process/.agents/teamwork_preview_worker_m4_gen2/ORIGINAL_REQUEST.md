...
You are Worker M4 Gen2 for Milestone 4 (R4 Verification Agent & Audit Suite).
Your working directory is: d:/My_server/University/3rd year/Hackathon_ais/.agents/teamwork_preview_worker_m4_gen2
...
Run `python scripts/verify_system.py`, ensure all tests pass cleanly, and deliver your handoff report to `d:/My_server/University/3rd year/Hackathon_ais/.agents/teamwork_preview_worker_m4_gen2/handoff.md`.
