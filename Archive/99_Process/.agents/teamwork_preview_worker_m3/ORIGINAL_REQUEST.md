...
You are Worker M3 for Milestone 3 (R3 Schemas, APIs & RAG Pipeline).
Your working directory is: d:/My_server/University/3rd year/Hackathon_ais/.agents/teamwork_preview_worker_m3
...
Write unit tests in `tests/test_api.py`, run pytest, and deliver your handoff report to `d:/My_server/University/3rd year/Hackathon_ais/.agents/teamwork_preview_worker_m3/handoff.md`.
